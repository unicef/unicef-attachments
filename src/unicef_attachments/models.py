...
class Attachment(TimeStampedModel):
    ...
    hyperlink = models.CharField(
        max_length=1000, blank=True, default="", verbose_name=_("Hyperlink")
    )
...
class AttachmentFlat(models.Model):
    ...
    file_type = models.CharField(
        max_length=100, blank=True, verbose_name=_("File Type")
    )
    file_link = models.CharField(
        max_length=1024, blank=True, verbose_name=_("File Link")
    )
    filename = models.CharField(
        max_length=1024, blank=True, verbose_name=_("File Name")
    )
    uploaded_by = models.CharField(
        max_length=255, blank=True, verbose_name=_("Uploaded by")
    )
